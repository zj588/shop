            ...
            <div class="AreaR">
                ...
                <div class="box">
                    <div class="box_1">
                        ...
                        <div class="screeBox">
                            <strong>品牌：</strong>
                            <?php if($_GET['brand_id'] == ''): ?><span>全部</span>
                            <?php else: ?>
                            <a href="<?php echo U('goodslist');?>">全部</a><?php endif; ?>

                            <?php if(is_array($brandDatas)): foreach($brandDatas as $key=>$b): if($_GET['brand_id'] == $b['id']): ?><span><?php echo ($b["brand_name"]); ?></span>
                            <?php else: ?>
                            <a href="<?php echo U('goodslist', array('brand_id'=>$b[id], 'goods_price'=>$_GET['goods_price']));?>"><?php echo ($b["brand_name"]); ?></a>&nbsp;<?php endif; endforeach; endif; ?>
                        </div>


                        <div class="screeBox">
                            <strong>价格：</strong>
                            <?php if($_GET['goods_price'] == ''): ?><span>全部</span>
                            <?php else: ?>
                            <a href="<?php echo U('goodslist', array('brand_id'=>$_GET['brand_id']));?>">全部</a><?php endif; ?>

                            <?php if(is_array($priceDatas)): foreach($priceDatas as $k=>$p): if($_GET['goods_price'] == $k): ?><span><?php echo ($p); ?></span>
                            <?php else: ?>
                            <a href="<?php echo U('goodslist', array('brand_id'=>$_GET['brand_id'], 'goods_price'=>$k));?>"><?php echo ($p); ?></a>&nbsp;<?php endif; endforeach; endif; ?>
                        </div>
                ...
                <div class="box">
                    <div class="box_1">
                        ...
                        <form name="compareForm" action="compare.php" method="post" onsubmit="return compareGoods(this);">
                            ...
                            <?php if(is_array($goodsDatas)): foreach($goodsDatas as $key=>$g): ?><div class="goodsItem">
                                    <a href="<?php echo U('detail', 'id='.$g['id']);?>" target="_blank"><img src="/Public/Home/images/32_thumb_G_1242110760196.jpg" alt="诺基亚N85" class="goodsimg"></a><br />
                                    <p><a href="#" title="诺基亚N85"><?php echo ($g["goods_name"]); ?></a></p>
                                    <font class="market_s">￥<?php echo ($g["goods_mprice"]); ?>元</font><br />
                                    <font class="shop_s">￥<?php echo ($g["goods_price"]); ?>元</font><br />
