        ...
        <div class="header_bg_b">
            <div class="f_l" style="padding-left: 10px;">
                <img src="/Public/Home/images/biao6.gif" />
                    <?php echo (getlocation($_SERVER['REMOTE_ADDR'])); ?>，现在下单(截至次日00:30已出库)，<b>明天上午(9-14点)</b>送达 <b>免运费火热进行中！</b>
            </div>
    ...
    "slides": [
        ...
        <div class="block clearfix">
            ...
            <div class="AreaL">
                ...
                <?php if(is_array($categoryTree)): foreach($categoryTree as $key=>$c): ?><dl>
                        <dt><a href="<?php echo U('goods/goodslist', 'id='.$c[id]);?>"><?php echo ($c["category_name"]); ?></a></dt>
                        <dd>
                        <?php if(is_array($c['_child'])): foreach($c['_child'] as $key=>$cc): ?><a href="<?php echo U('goods/goodslist', 'id='.$cc[id]);?>"><?php echo ($cc["category_name"]); ?></a><?php endforeach; endif; ?>
                        </dd>
            ...
            <div class="AreaM">
                ...
                <div class="itemTit" id="itemHot">
                    ...
                    <?php if(is_array($categoryTree)): foreach($categoryTree as $key=>$c): if(is_array($c['_child'])): foreach($c['_child'] as $key=>$cc): ?><h2 class="h2bg"><a class="hot" data-id="<?php echo ($cc["id"]); ?>" href="javascript:void(0);" ><?php echo ($cc["category_name"]); ?></a></h2><?php endforeach; endif; endforeach; endif; ?>
                </div>
                <div id="show_hot_area" class="clearfix">
                    <?php if(is_array($hotGoods)): foreach($hotGoods as $key=>$h): ?><div class="goodsItem">

                        <a href="<?php echo U('goods/detail', 'id='.$h['id']);?>"><img src="/Public/Home/images/9_thumb_G_1241511871555.jpg" alt="诺基亚E66" class="goodsimg"></a><br />
                        <p class="f1"><a href="#" title="<?php echo ($h["goods_name"]); ?>"><?php echo ($h["goods_name"]); ?></a></p>
                        <font class="market">￥<?php echo ($h["goods_mprice"]); ?>元</font><br />
                        <font class="f1">
                            ￥<?php echo ($h["goods_price"]); ?>元                     </font>
                ...
                <div class="itemTit" id="itemBest">
                    ...
                    <?php if(is_array($categoryTree)): foreach($categoryTree as $key=>$c): if(is_array($c['_child'])): foreach($c['_child'] as $key=>$cc): ?><h2 class="h2bg"><a class="recommend" data-id="<?php echo ($cc["id"]); ?>" href="javascript:void(0);" ><?php echo ($cc["category_name"]); ?></a></h2><?php endforeach; endif; endforeach; endif; ?>
                </div>
                <div id="show_best_area" class="clearfix">
                    <?php if(is_array($recGoods)): foreach($recGoods as $key=>$r): ?><div class="goodsItem">

                        <a href="<?php echo U('goods/detail', 'id='.$r['id']);?>"><img src="/Public/Home/images/9_thumb_G_1241511871555.jpg" alt="诺基亚E66" class="goodsimg"></a><br />
                        <p class="f1"><a href="#" title="<?php echo ($r["goods_name"]); ?>"><?php echo ($r["goods_name"]); ?></a></p>
                        <font class="market">￥<?php echo ($r["goods_mprice"]); ?>元</font><br />
                        <font class="f1">
                            ￥<?php echo ($r["goods_price"]); ?>元                     </font>
                    </div><?php endforeach; endif; ?>
                ...
                <div class="itemTit" id="itemNew">
                    ...
                    <?php if(is_array($categoryTree)): foreach($categoryTree as $key=>$c): if(is_array($c['_child'])): foreach($c['_child'] as $key=>$cc): ?><h2 class="h2bg"><a class="new" data-id="<?php echo ($cc["id"]); ?>" href="javascript:void(0);" ><?php echo ($cc["category_name"]); ?></a></h2><?php endforeach; endif; endforeach; endif; ?>
                </div>
                <div id="show_new_area" class="clearfix">
                    <?php if(is_array($newGoods)): foreach($newGoods as $key=>$n): ?><div class="goodsItem">

                        <a href="<?php echo U('goods/detail', 'id='.$n['id']);?>"><img src="/Public/Home/images/9_thumb_G_1241511871555.jpg" alt="诺基亚E66" class="goodsimg"></a><br />
                        <p class="f1"><a href="#" title="<?php echo ($n["goods_name"]); ?>"><?php echo ($n["goods_name"]); ?></a></p>
                        <font class="market">￥<?php echo ($n["goods_mprice"]); ?>元</font><br />
                        <font class="f1">
                            ￥<?php echo ($n["goods_price"]); ?>元                     </font>
                    </div><?php endforeach; endif; ?>
                ...
                <script>
                    $(function () {
                        $('.new').click(function () {
                            ...
                            $.post('/index.php/Home/Index/getNew', data , function (data) {
                                // console.log(data);
                                var str = '';
                                $.each(data, function (key, item) {
                                    str += '<div class="goodsItem"><a href="<?php echo U('goods/detail', 'id='.$n['id']);?>"><img src="/Public/Home/images/9_thumb_G_1241511871555.jpg" alt="'+item.goods_name+'" class="goodsimg"></a><br /><p class="f1"><a href="#" title="'+item.goods_name+'">'+item.goods_name+'</a></p><font class="market">￥'+item.goods_mprice+'元</font><br /><font class="f1">￥'+item.goods_price+'元                     </font></div>';
                                });
                                $('#show_new_area').html(str);
                            }, 'json');
                        });
                        ...
                        $('.recommend').click(function () {
                            ...
                            $.post('/index.php/Home/Index/getRec', data , function (data) {
                                console.log(data);
                                var str = '';
                                $.each(data, function (key, item) {
                                    str += '<div class="goodsItem"><a href="<?php echo U('goods/detail', 'id='.$n['id']);?>"><img src="/Public/Home/images/9_thumb_G_1241511871555.jpg" alt="'+item.goods_name+'" class="goodsimg"></a><br /><p class="f1"><a href="#" title="'+item.goods_name+'">'+item.goods_name+'</a></p><font class="market">￥'+item.goods_mprice+'元</font><br /><font class="f1">￥'+item.goods_price+'元                     </font></div>';
                                });
                                $('#show_best_area').html(str);
                            }, 'json');
                        });
                        ...
                        $('.hot').click(function () {
                            ...
                            $.post('/index.php/Home/Index/getHot', data , function (data) {
                                console.log(data);
                                var str = '';
                                $.each(data, function (key, item) {
                                    str += '<div class="goodsItem"><a href="<?php echo U('goods/detail', 'id='.$n['id']);?>"><img src="/Public/Home/images/9_thumb_G_1241511871555.jpg" alt="'+item.goods_name+'" class="goodsimg"></a><br /><p class="f1"><a href="#" title="'+item.goods_name+'">'+item.goods_name+'</a></p><font class="market">￥'+item.goods_mprice+'元</font><br /><font class="f1">￥'+item.goods_price+'元                     </font></div>';
                                });
                                $('#show_hot_area').html(str);
                            }, 'json');
                        });
                    });
                </script>
