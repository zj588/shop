        ...
        <div class="header_bg_b">
            <div class="f_l" style="padding-left: 10px;">
                <img src="/Public/Home/images/biao6.gif" />
                    <?php echo (getlocation(session('ip'))); ?>，现在下单(截至次日00:30已出库)，<b>明天上午(9-14点)</b>送达 <b>免运费火热进行中！</b>
            </div>
        ...
        <div class="block block1">
            ...
            <div class="usBox clearfix">
                <div class="usBox_1 f_l">
                    ...
                    <form name="formLogin" action="/index.php/Home/login/login.html" method="post">
                ...
                <div class="usTxt">
                    ...
                    <div style="padding-left: 50px;">
                        ...
                        3. 享受会员积分制度<br />
                        4. 订阅本店商品信息  <br />
                        <a href="<?php echo U('user/reg');?>"><img src="/Public/Home/images//bnt_ur_reg.gif"></a>
                    </div>
                </div>
            </div>
            </div>
