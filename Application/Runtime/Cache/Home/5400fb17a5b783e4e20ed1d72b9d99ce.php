                ...
                <table style="border: 1px solid rgb(221, 221, 221); margin: 20px auto;" align="center" bgcolor="#ffffff" border="0" cellpadding="15" cellspacing="0" width="99%">
                    <tbody><tr>
                            <td align="center" bgcolor="#ffffff">
                                您选定的配送方式为: <strong><?php echo (getSendType($order_data["order_send"])); ?></strong>，您选定的支付方式为: <strong><?php echo (getPayType($order_data["order_pay_type"])); ?></strong>。您的应付款金额为: <strong>￥<?php echo ($order_data["order_price"]); ?>元</strong>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" bgcolor="#ffffff"><a href="<?php echo U('paynow', 'oid='.$order_data['id']);?>">立即支付</a></td>
                        </tr>
                    </tbody></table>
                <p style="text-align: center; margin-bottom: 20px;">您可以 <a href="#">返回首页</a> 或去 <a href="<?php echo U('ucenter/center');?>">用户中心</a></p>
            </div>
        </div>
