                ...
                <tr>
                    ...
                    <td>
                        <select name="pid">
                            ...
                            <?php if(is_array($data)): foreach($data as $key=>$d): ?><option value="<?php echo ($d["id"]); ?>"><?php echo (str_repeat('&nbsp&nbsp',$d["level"])); echo ($d["menu_name"]); ?></option><?php endforeach; endif; ?>
